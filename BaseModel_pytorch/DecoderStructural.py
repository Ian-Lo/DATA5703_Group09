...
class DecoderStructural(torch.nn.Module):
    ...
    def forward(self, encoded_features_map, structural_target):
        ...
        for t in range(0, num_timesteps):
            ...
            prediction, structural_hidden_state, attention_weight = self.timestep(encoded_features_map[:batch_size_t],
                                                                                  structural_input[:batch_size_t],
                                                                                  structural_hidden_state[:,
                                                                                  :batch_size_t, :])
