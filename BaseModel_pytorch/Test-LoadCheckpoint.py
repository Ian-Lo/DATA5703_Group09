...
for param_tensor in model.encoder.state_dict():
    print(param_tensor, "\t", model.encoder.state_dict()[param_tensor])
#import cProfile
#import re
...
#cProfile.run('model.train(epochs=epochs, lambdas=lambdas, lrs=lrs, number_examples=number_examples, number_examples_val=number_examples_val, batch_size=batch_size, storage_size=storage_size,val = val)', "profiling")
# train model
